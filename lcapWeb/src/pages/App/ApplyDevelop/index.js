...
import { Input, Button, message, SearchBar, Icon, Pagination, Progress, Popconfirm, Tooltip, Menu, Dropdown,Select } from "@chaoswise/ui";
import {
    observer
...

        {
          <div style={{ minHeight: "calc(100vh - 292px)" }}>
            <TsetCard
              ...
              showStateTag={true}
              actions={(item) => {
                const isLcap = 'lcap-init'===item.from;
                return (
                  <>
                    {
                    ...
                    }
                    {
                      <Tooltip key="delete" title="删除">
                        ...
                        >
                          <a title="删除">
                            <Icon type="delete" style={{color:isLcap?'#ccc':'#333'}} />
                          </a>
                        </Popconfirm>
                      </Tooltip>
                    }
