...
hubMonitorListReducer.reducer = 'hubMonitorListReducer';
export default function hubMonitorListReducer(state = initState, action) {
    switch (action.type) {
        // 更新主机列表
        ...
        // 更新表格数据
        case actionTypes.UPDATE_HUBLIST: {
            return update(state, {
                monitorList: {
                    $set: {
                        ...action.data,
