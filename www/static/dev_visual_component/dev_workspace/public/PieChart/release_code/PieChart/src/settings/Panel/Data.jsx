...
class Data extends React.Component {
  ...
  handleContentChange = (value) => {
    ...
    if (!this.validateState) {
      ...
      if (transferData) {
        this.toggleEditor();
        this.props.onChange({ [key]: transferData })
      }
    }
  }
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        >
          <Input.TextArea value={formatValues.transferXAxisData} style={{ height: '30vh' }} placeholder="请输入格式xAxis函数" disabled />
        </FormItem>
        <FormItem
        ...
        >
          <Input.TextArea value={formatValues.transferSeriesData} style={{ height: '30vh' }} placeholder="请输入格式data函数" disabled />
        </FormItem>
        {
          formatValues[key]
          &&
