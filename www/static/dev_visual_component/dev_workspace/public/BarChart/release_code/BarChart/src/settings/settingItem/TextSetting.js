...
const TextSetting = ({
  ...
  return (
    <FormItemGroup title={title}>
      ...
      <FormItem label="shadowColor" extra="文字块的背景阴影颜色">
        <ColorPickerInput
          value={shadowColor}
          onChange={(color) => onChange('shadowColor', color)}
        />
      </FormItem>
      <FormItem label="shadowBlur" extra="文字块的背景阴影长度">
        <InputNumber
          value={shadowBlur}
          onChange={val => onChange('shadowBlur', val)}
        />
      </FormItem>
      <FormItem label="shadowOffsetX" extra="文字块的背景阴影 X 偏移">
        <InputNumber
          value={shadowOffsetX}
          onChange={val => onChange('shadowOffsetX', val)}
        />
      </FormItem>
      <FormItem label="shadowOffsetY" extra="文字块的背景阴影 Y 偏移">
        <InputNumber
          value={shadowOffsetY}
