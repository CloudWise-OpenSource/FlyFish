  ...
  render() {
    ...
    return (
      <Form>
        ...
        <FormItem label="realtimeSort" extra="用于制作动态排序图">
          <RadioBooleanGroup
            value={realtimeSort}
            onChange={(event) =>
              this.updateOptions({
        ...
        <FormItem label="sortSeriesIndex" extra="动态排序图用于排序的系列 id。目前只支持一个系列的图排序效果，所以这个值只能取 0。仅当轴 realtimeSort 为 true 并且 type 是 'value' 时有效。">
          <InputNumber
