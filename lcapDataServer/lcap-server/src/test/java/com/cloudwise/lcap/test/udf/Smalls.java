...
public class Smalls {
  ...
  public static final Method GENERATE_STRINGS_OF_INPUT_SIZE_METHOD = Types.lookupMethod(Smalls.class, "generateStringsOfInputSize", List.class);
  public static final Method GENERATE_STRINGS_OF_INPUT_MAP_SIZE_METHOD = Types.lookupMethod(Smalls.class, "generateStringsOfInputMapSize", Map.class);
  ...
  public static final Method FIBONACCI_LIMIT_100_TABLE_METHOD = Types.lookupMethod(Smalls.class, "fibonacciTableWithLimit100");
  public static final Method FIBONACCI_LIMIT_TABLE_METHOD = Types.lookupMethod(Smalls.class, "fibonacciTableWithLimit", long.class);
  public static final Method FIBONACCI_INSTANCE_TABLE_METHOD = Types.lookupMethod(FibonacciTableFunction.class, "eval");
  public static final Method DUMMY_TABLE_METHOD_WITH_TWO_PARAMS = Types.lookupMethod(Smalls.class, "dummyTableFuncWithTwoParams", long.class, long.class);
  public static final Method DYNAMIC_ROW_TYPE_TABLE_METHOD = Types.lookupMethod(Smalls.class, "dynamicRowTypeTable", String.class, int.class);
  ...
  public static final Method MY_PLUS_EVAL_METHOD = Types.lookupMethod(MyPlusFunction.class, "eval", int.class, int.class);
  public static final Method MY_PLUS_INIT_EVAL_METHOD = Types.lookupMethod(MyPlusInitFunction.class, "eval", int.class, int.class);
  ...
  private static QueryableTable oneThreePlus(String s) {
    ...
    return new AbstractQueryableTable(Integer.class) {
      @Override
      public <E> Queryable<E> asQueryable(QueryProvider queryProvider, SchemaPlus schema,
          String tableName) {
  ...
  public static QueryableTable generateStrings(final Integer count) {
    return new AbstractQueryableTable(IntString.class) {
      ...
      public <T> Queryable<T> asQueryable(QueryProvider queryProvider, SchemaPlus schema,
          String tableName) {
        BaseQueryable<IntString> queryable = new BaseQueryable<IntString>(null, IntString.class,
            null) {
          @Override
  ...
  public static QueryableTable multiplicationTable(final int ncol, final int nrow, Integer offset) {
    ...
    return new AbstractQueryableTable(Object[].class) {
      ...
      @Override
      public Queryable<Object[]> asQueryable(QueryProvider queryProvider, SchemaPlus schema,
          String tableName) {
  ...
  public static TranslatableTable view(String s) {
    return new ViewTable(Object.class, typeFactory -> typeFactory.builder().add("c",
        SqlTypeName.INTEGER).build(), "values (1), (3), " + s, ImmutableList.of(), Arrays.asList("view"));
  }

  public static TranslatableTable strView(String s) {
    return new ViewTable(Object.class, typeFactory -> typeFactory.builder().add("c",
        SqlTypeName.VARCHAR, 100).build(),
        "values (" + CalciteSqlDialect.DEFAULT.quoteStringLiteral(s) + ")", ImmutableList.of(),
        Arrays.asList("view"));
  }
  ...
  public static TranslatableTable str(Object o, Object p) {
    ...
    return new ViewTable(Object.class, typeFactory -> typeFactory.builder().add("c",
        SqlTypeName.VARCHAR, 100).build(),
        "values " + CalciteSqlDialect.DEFAULT.quoteStringLiteral(o.toString()) + ", " + CalciteSqlDialect.DEFAULT.quoteStringLiteral(p.toString()), ImmutableList.of(), Arrays.asList("view"));
  }
  ...
  public static class MyPlusInitFunction {
    public static final ThreadLocal<AtomicInteger> INSTANCE_COUNT =
        ThreadLocal.withInitial(() -> new AtomicInteger(0));
    public static final ThreadLocal<String> THREAD_DIGEST = new ThreadLocal<>();
    ...
    public MyPlusInitFunction(FunctionContext fx) {
      ...
      for (int i = 0; i < parameterCount; i++) {
        ...
        if (fx.isArgumentConstant(i)) {
          b.append(" is constant and has value ").append(fx.getArgumentValueAs(i, String.class));
        } else {
          b.append(" is not constant");
        }
      }
      THREAD_DIGEST.set(b.toString());
      this.initY = fx.isArgumentConstant(1) ? fx.getArgumentValueAs(1, Integer.class) : 100;
    }
  ...
  public static class MyDeterministicPlusFunction {
    ...
    public Integer eval(@Parameter(name = "x") Integer x, @Parameter(name = "y") Integer y) {
      if (x == null || y == null) {
        return null;
      }
      return x + y;
  ...
  public static class MyAbcdeFunction {
    public String eval(@Parameter(name = "A", optional = false) Integer a, @Parameter(name = "B",
        optional = true) Integer b, @Parameter(name = "C", optional = false) Integer c,
        @Parameter(name = "D", optional = true) Integer d, @Parameter(name = "E",
        optional = true) Integer e) {
  ...
  public static class TableMacroFunctionWithNamedParameters {
    public TranslatableTable eval(@Parameter(name = "R", optional = true) String r,
  ...
  public static class AnotherTableMacroFunctionWithNamedParameters {
    public TranslatableTable eval(@Parameter(name = "R", optional = true) String r,
        @Parameter(name = "S") String s, @Parameter(name = "T", optional = true) Integer t,
  ...
  public static class WideSaleSchema {
    ...
    public final WideProductSale[] prod = {new WideProductSale(100, 10)};
  }
