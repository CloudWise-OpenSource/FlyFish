...
public class AesUtils {
    ...
    public static void main(String[] args) {
        try {
            String src = "Js1MJwkNJkaPs78XYJaJiKzSQGsROKUoYsj9lnz0GBcUo1vYWFeG0xqnSL69D8zrt/4vFLhxOLznRMtflE2oLCAggq56JF4wealWlZpN2PePBanDRdbXSTM4c0a+ItwG0TWZZ/oJMP9X+v/bT3MpGNRIStrTgjCJtHL9g66DlQPevFUAhmKbM17y+ftAml5W4bKG63c67yGxRhomtqMWZA==";
            System.out.println("原字符串:" + src);
            byte[] encrypted64 = Base64.decodeBase64(src);
//            String enc = encrypt(src);
//            System.out.println("加密后的结果：" + enc);
            String decrypt = decrypt( byteToHexString(encrypted64));
