...
public class JsonUtils {
    ...
    public static String toJSONString(Object o) {
        ...
        try {
            ...
            log.error("JsonUtils convert  to String error {}",  e);
        }
        return result;
    }
    ...
    public static <T> T parse(String jsonString, Class<T> clazz) {
        ...
        try {
            ...
            log.error("JsonUtils parse string  to object error {}", e);
        }
        return t;
    }
    ...
    public static String sortJsonString(Map map) {
        ...
        try {
            ...
            log.error("JsonUtils sortJsonString map error {}", e);
        }
        return result;
    }
    ...
    public static String replaceJsonBlank(String jsonString){
        ...
        try {
            ...
            log.error("JsonUtils replace to blank error {}", e);
        }
        if (null == actualObj) {
            return null;
        }
