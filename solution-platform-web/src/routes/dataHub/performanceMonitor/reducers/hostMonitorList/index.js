...
hostMonitorListReducer.reducer = 'hostMonitorListReducer';
export default function hostMonitorListReducer(state = initState, action) {
    switch (action.type) {
        // 更新主机列表
        ...
        // 更新表格数据
        case actionTypes.UPDATE_HOSTLIST: {
            return update(state, {
                monitorList: {
                    $set: {
                        ...action.data,
