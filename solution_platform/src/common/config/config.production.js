...
const wwwDirPath = "/resources/flyFish/solution-platform-server/www";
...
module.exports = {
    ...
    custom: {
        ...
        screenDownloadUrl: "http://10.2.2.236:8360",
        //图片存储目录
        imgDir: '',
        uploadImgDir: wwwDirPath+ '/' + path,        //配置文件管理-图片上传路径
        urlPath: 'http://10.2.2.236:8362/' + path,                  //配置文件管理中图片的url地址
        solution_domain: 'http://10.2.2.236:8362',                   //解决方案主机
