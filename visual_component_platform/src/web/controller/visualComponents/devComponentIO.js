...
module.exports = class extends Base{
    ...
    constructor(ctx) {
        ...
        this.devComponentIOService = think.service('visualComponents/devComponentIO', think.config("custom.appModules.web"));
    }
    ...
    async initDevWorkspaceAction(){
        ...
        const {user_name} = await this.getCacheUserInfo();
        const targetComponentMarkPath = await this.devComponentIOService.initDevWorkspace(component_id, {user_name});
    ...
    async compileDevComponentAction(){
        const { component_id, user_id } = this.post();

        const compileRes = await this.devComponentIOService.compileComponent(component_id, {user_id});
