...
const EnumUserStatus = require('../../../common/constants/app/user/EnumUser').EnumUserStatus;
...
const mkUserPassword = require('../../../common/constants/app/user/EnumUser').mkUserPassword;
...
module.exports = class extends Base {
    ...
    async loginAction() {
        ...
        return this.success(loginInfo, "登录成功");
    }
