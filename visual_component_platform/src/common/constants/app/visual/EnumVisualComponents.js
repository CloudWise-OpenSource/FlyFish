...
exports.EnumComponentIOPath = (() => {
  ...
  const devComponentTpl = path.resolve(
    think.ROOT_PATH,
    "templates/visual_component/dev_component_tpl"
  );
  const releaseCodeBase = path.resolve(
    think.ROOT_PATH,
    "templates/visual_component/release_code"
  );
  const publicDir = path.resolve(
    think.ROOT_PATH,
    "templates/visual_component/dev_component_tpl/public"
  );
  ...
  const npmrcTpl = () =>
    require(path.resolve(devComponentTpl, ".npmrc.js"))();
  ...
  return {
    ...
    target: (org_mark = null, component_mark = null) => {
      ...
      const npmrcFile = path.resolve(componentMarkPath, ".npmrc");
